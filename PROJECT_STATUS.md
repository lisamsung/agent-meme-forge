...
- `meme_pack.py` 已实现基础处理流程：梗库、prompt 计划、contact sheet 切图、中文文案排版、GIF 生成、微信投稿包导出、manifest 生成。
...
- 已补强“主动生图”链路：`plan-pack` 生成角色卡和逐条 `image_gen` prompt；`split-sheet` 支持把 4x6 生图表切成 24 个源图。
