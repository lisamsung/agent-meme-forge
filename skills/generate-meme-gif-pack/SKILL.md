...
- For subtle reactions such as blink, nod, loading, or blank stare, prompt for micro-motion and in-between frames. Keep the head anchor, shoulder line, hand pose, and crop nearly fixed; do not accept eight unrelated poses stitched together.
...
5. Generate and QC raw images:
   ...
   - Each sheet frame should be a real acting beat: start, anticipation, action, escalation, peak reaction, rebound, settle, loopable return. For quiet reactions, use tiny eyelid/pupil/head changes instead of big pose jumps.
