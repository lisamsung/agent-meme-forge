...
| AI 吉祥物 24 微信包 | `wechat` | `clean-sticker` | `科研打工人` | 24 | 69,798 | 24 | 9,591 | 10,762 / 1,538 / 28,873 |

## ImageGen Sample

- Plan: `output/ai-research-plan.json`
- Raw sheets: `output/demo-raw-2x4/01-收到离线-2x4.png ... 24-*.png`
- WeChat package: `output/ai-mascot-demo-pack/`
- Published preview assets: `docs/assets/ai-mascot-sheet-preview.jpg`, `docs/assets/ai-mascot-shoudao-lixian.gif`, `docs/assets/ai-mascot-jiazaizhong.gif`, and `docs/assets/ai-mascot-wenxianshan.gif`
...
The published GIF previews have been regenerated from real `2x4` motion sheets and contain semantic frames instead of single static pose bounce.
...
- AI 吉祥物 demo 的 strict QC 全部通过，最大主 GIF 约 `69.8KB`。
...
- 投稿模式应优先看 `qc_report.json`，不要把 `single_bounce` 或棋盘格假透明当成最终成品。
...
v0.1.0 发布门禁共收集 85 项自动化测试；当前通过状态以仓库 CI 为准。
