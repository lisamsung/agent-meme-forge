...
- Other conduct that could reasonably be considered inappropriate professionally
...
align with this Code of Conduct, and will communicate moderation reasons when
appropriate.
...
[maintainer's GitHub profile](https://github.com/lisamsung). Do not open a
...
the privacy and security of reporters as far as reasonably possible.

## Enforcement guidelines

Maintainers will use these community-impact guidelines when deciding on
consequences:

1. **Correction** — A private warning and explanation for inappropriate
   language or other unprofessional behavior.
2. **Warning** — A warning with consequences for continued behavior, including
   restrictions on interaction for a specified period.
3. **Temporary ban** — A temporary ban from interaction or public communication
   with the community.
4. **Permanent ban** — Permanent removal from project participation for a
   pattern of violations or severe harassment.
